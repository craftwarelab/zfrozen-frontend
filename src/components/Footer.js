...
const Footer = () => {
  ...
  return (
    <footer className="bg-white">
      <div className="max-w-screen-xl px-4 pt-16 pb-8 mx-auto sm:px-6 lg:px-8 overflow-hidden">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <div className="flex mt-4 sm:mt-8 space-x-2 sm:space-x-4 text-gray-600">
              <a
                className="hover:opacity-95 p-2 rounded-[6px] bg-[#FFD700] hover:cursor-pointer"
                href
                target="_blank"
                rel="noreferrer"
              >
